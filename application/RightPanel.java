...
public class RightPanel extends GridPane {
	...
	/*
	 * fromLeft_tf.setPrefWidth(80); fromRight_tf.setPrefWidth(80);
	 * toLeft_tf.setPrefWidth(80); toRight_tf.setPrefWidth(80);
	 */
	 ...
	 * 
	 * //to_hbox.setSpacing(20); //to_hbox.getChildren().addAll(to_lbl, toLeft_tf,
	 * toRight_tf); //to_hbox.setMargin(toLeft_tf, new Insets(0, 0, 0, 22));
	 * 
	 ...
	 */
	/*
	 * rightSide_vbox.getChildren().addAll(info_hbox, playerMoney_lbl, from_hbox,
	 * to_hbox, buildCost_lbl, build_hbox);
	 */
